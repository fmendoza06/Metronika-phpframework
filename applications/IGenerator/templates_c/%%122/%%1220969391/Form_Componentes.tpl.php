<?php /* Smarty version 2.6.0, created on 2010-09-07 10:08:22
         compiled from Form_Componentes.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'form', 'Form_Componentes.tpl', 25, false),array('block', 'fieldset', 'Form_Componentes.tpl', 43, false),array('function', 'ListComponents', 'Form_Componentes.tpl', 28, false),array('function', 'btn_command', 'Form_Componentes.tpl', 34, false),array('function', 'hidden', 'Form_Componentes.tpl', 40, false),)), $this); ?>
<HTML>
<HEAD>
      ...
      <td width="600" rowspan="3">
       ...
       <tr>
         <td><IMG SRC="web/images/usuario_03.gif" WIDTH=5 HEIGHT=6 ALT=""></td>
			...
			<?php echo smarty_function_ListComponents(array('check_all' => $this->_tpl_vars['checkall']), $this);?>
            ...
            <div style="position:absolute; left:367px; top:211px; width:84px; height:36px; z-index:2">
                <table border="0" align="center">
                	<tr>
                	    <td><?php echo smarty_function_btn_command(array('type' => 'button','value' => 'Next','name' => 'CmdDefaultTablasBD','form_name' => 'frm_dir'), $this);?>
</td>
                		<td><?php echo smarty_function_btn_command(array('type' => 'button','value' => 'Cancel','name' => 'CmdBackLookAndFeel','form_name' => 'frm_dir'), $this);?>
</td>
                	</tr>
                </table>
            </div>
