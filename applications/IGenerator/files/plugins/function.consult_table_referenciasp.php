...
{     
  ...
  $html_result = '';
  $html_result .= "<select name='sel_condicionfield' class='selectpicker'>";
...
{
  $html_result = '';
  $html_result .= "<select name='sel_condiction' class='selectpicker col-mt-18'>";
...
// $html_tabla .= "<tr>";
 ...
 if($numero_pagina != 1){
    $html_tabla .= "<td><div align='center'><a href='#' onClick=\"".$form_name.".".$table_name."__pagina_consult.value = parseInt(".$form_name.".".$table_name."__pagina_consult.value)-1;".$form_name.".action.value='".$command."';".$form_name.".submit();\"><IMG class='imgDoc' src='web/images/rewind.png'></a></div></td>";
    
 }else{
    $html_tabla .= "<td><div align='center'><IMG src='web/images/rewinddark.png'></div></td>";
 }
 ...
 if($numero_pagina < $cantidad_paginas){
    $html_tabla .= "<td><div align='center'><a href='#' onClick=\"".$form_name.".".$table_name."__pagina_consult.value = parseInt(".$form_name.".".$table_name."__pagina_consult.value)+1;".$form_name.".action.value='".$command."';".$form_name.".submit();\"><IMG class='imgDoc' src='web/images/forward.png'></a></div></td>";
    
 }else{
    $html_tabla .= "<td><div align='center'><IMG src='web/images/forwarddark.png'></div></td>";
 }
 //$html_tabla .= "</tr>";
 
// $html_tabla .= "<tr>";

 $html_tabla .= "<td><div align='center'><input type='button' value='  Ir  ' onClick=\"if((".$form_name.".".$table_name."__pagina_consult.value < 1) || (".$form_name.".".$table_name."__pagina_consult.value > ".$cantidad_paginas.")){";
