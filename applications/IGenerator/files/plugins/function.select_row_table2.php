...
function smarty_function_select_row_table2($params, &$smarty)
{
  extract($params);
  ...
  $html_result .= "<select  name='$name' $idn  size='$size' $event $disabled data-placeholder='Select Option...' tabindex='2' $multipleparam>";
  
  $html_result .= "<option value='0'> -- Select -- </optional>";
