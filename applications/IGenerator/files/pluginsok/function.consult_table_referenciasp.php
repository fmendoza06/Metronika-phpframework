...
function smarty_function_consult_table_referenciasp($params, &$smarty)
{
...
function CrearMecanismoBusqueda(&$html_tabla,$form_name,$command,$cantidad_paginas,$table_name,$filter,$Toolsbar)
{
   ...
   //										
    $html_tabla .= "                     <div class='input-group'> 
	                                      <a  class='btn btn-mint btn-rounded' Onclick=\"disableButtons();action.value='".$command."';";
    if($cantidad_paginas > 1 ){
                           $html_tabla .= $table_name."__pagina_consult.value = '1';";
                       }
                       $html_tabla .= $form_name.".submit();\">";	
    $html_tabla .= "
                                             <i class='fa fa-life-ring  fa-lg '></i>".$Toolsbar[find]."
									      </a>										    
										 </div>	
										</div>";
...
{     
  ...
  $html_result = '';
  $html_result .= "<select name='sel_condicionfield' class='selectpicker col-mt-12'>";
...
{
  $html_result = '';
  $html_result .= "<select name='sel_condiction' class='selectpicker col-mt-12'>";
...
// $html_tabla .= "<tr>";
 ...
 if($numero_pagina != 1){
    $html_tabla .= "<td width=10% height=10 ><div align='center'><a href='#' onClick=\"".$form_name.".".$table_name."__pagina_consult.value = parseInt(".$form_name.".".$table_name."__pagina_consult.value)-1;".$form_name.".action.value='".$command."';".$form_name.".submit();\"><IMG class='imgDoc' src='web/images/rewind.png'></a></div></td>";
    
 }else{
    $html_tabla .= "<td width=10% height=10 ><div align='center'><IMG class='imgDoc' src='web/images/rewinddark.png'></div></td>";
 }

 $html_tabla .= "<td width=10% hieght=10 ><div align='center'><input type='text' name='".$table_name."__pagina_consult' maxlength='3' size='2' value='".$numero_pagina."' ";
 ...
 if($numero_pagina < $cantidad_paginas){
    $html_tabla .= "<td width=10%  height=10 ><div align='center'><a href='#' onClick=\"".$form_name.".".$table_name."__pagina_consult.value = parseInt(".$form_name.".".$table_name."__pagina_consult.value)+1;".$form_name.".action.value='".$command."';".$form_name.".submit();\"><IMG class='imgDoc' src='web/images/forward.png'></a></div></td>";
    
 }else{
    $html_tabla .= "<td width=10% heightt=10 ><div align='center'><IMG class='imgDoc' src='web/images/forwarddark.png'></div></td>";
 }
 //$html_tabla .= "</tr>";
 
// $html_tabla .= "<tr>";

 $html_tabla .= "<td width=10% height=10 colspan=3 ><div align='center'><input class='boton' type='button' value='  Ir  ' onClick=\"if((".$form_name.".".$table_name."__pagina_consult.value < 1) || (".$form_name.".".$table_name."__pagina_consult.value > ".$cantidad_paginas.")){";
