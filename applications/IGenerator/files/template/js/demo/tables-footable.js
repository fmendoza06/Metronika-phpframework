...
$(window).on('load', function() {
	...
	// Filter status
	$('#demo-foo-filter-job').change(function (e) {
		e.preventDefault();
		filtering.trigger('footable_filter', {filter: $(this).val()});
	});	
	...
	$('#demo-show-entries2').change(function (e) {
		e.preventDefault();
		var pageSize = $(this).val();
		$('#demo-foo-filtering').data('page-size', pageSize);
		$('#demo-foo-filtering').trigger('footable_initialized');
	});
