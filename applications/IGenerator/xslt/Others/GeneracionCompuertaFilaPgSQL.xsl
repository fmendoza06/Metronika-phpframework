...
<xsl:template match="declaration">
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo constructor de la clase tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para validar si un dato existe en la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
  ...
  <xsl:apply-templates mode="VALIDAR_FUNCION_UPDATE" select="field"/>
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para eliminar datos a la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para consultar por campo(s) clave(s) y obtener todas las columnas de la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para consultar todos los registros y obtener todas las columnas de la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
...
<xsl:template mode="FUNCIONES_GET" match="field">
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para consultar por el(los) campo(s) llave(s) y obtener la columna <xsl:call-template name="convertpropercase"><xsl:with-param name="toconvert" select="name"/></xsl:call-template> de la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
...
<xsl:template mode="DETERMINA_LLAVES_FORANEAS" match="declaration/foreign_key">  
 <xsl:if test="count(ancestor::declaration/foreign_key) > 0 ">
  <xsl:apply-templates select="ancestor::local_table/field"/>
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para consultar por la llave foranea <xsl:call-template name="convertpropercase"><xsl:with-param name="toconvert" select="name"/></xsl:call-template> y obtener todas las columnas de la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
...
<!-- Muestra la Función Update -->
  <xsl:template mode="FUNCION_UPDATE" match="declaration">
	...
	* @Copyright 2005 Parquesoft
	*
	* Metodo para actualizar los datos a la tabla: <xsl:value-of select="$tabla"/>
	* @author Ingravity 0.0.9
	* @location Cali - Colombia
	*/
