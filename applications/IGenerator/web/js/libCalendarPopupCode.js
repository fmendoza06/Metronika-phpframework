...
function headerCalendar(){
	return (
	'<td>'+(this.obj_caller && this.obj_caller.year_scroll?'<a href="javascript:set_datetime('+this.dt_prev_year.valueOf()+')"><img src="'+STR_ICONPATH+'prev_year.png" width="16" height="16" border="0" alt="'+ARR_ALT[0]+'"></a>&nbsp;':'')+'<a href="javascript:set_datetime('+this.dt_prev_month.valueOf()+')"><img src="'+STR_ICONPATH+'prev.png" width="16" height="16" border="0" alt="'+ARR_ALT[1]+'"></a></td>'+
	'<td align="center" width="100%"><font color="#ffffff">'+ARR_MONTHS[this.dt_current.getMonth()]+' '+this.dt_current.getFullYear() + '</font></td>'+
	'<td><a href="javascript:set_datetime('+this.dt_next_month.valueOf()+')"><img src="'+STR_ICONPATH+'next.png" width="16" height="16" border="0" alt="'+ARR_ALT[2]+'"></a>'+(this.obj_caller && this.obj_caller.year_scroll?'&nbsp;<a href="javascript:set_datetime('+this.dt_next_year.valueOf()+')"><img src="'+STR_ICONPATH+'next_year.png" width="16" height="16" border="0" alt="'+ARR_ALT[3]+'"></a>':'')+'</td>'
	);
}
