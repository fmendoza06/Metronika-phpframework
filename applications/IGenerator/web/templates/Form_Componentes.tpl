      ...
      <td width="600" rowspan="3">
       ...
       <tr>
         <td><IMG SRC="web/images/usuario_03.gif" WIDTH=5 HEIGHT=6 ALT=""></td>
			...
			{ListComponents check_all=$checkall }
			</div>  
           
            <div style="position:absolute; left:367px; top:211px; width:84px; height:36px; z-index:2">
                <table border="0" align="center">
                	<tr>
                	    <td>{btn_command type="button" value="Next" name="CmdDefaultTablasBD" form_name="frm_dir"}</td>
                		<td>{btn_command type="button" value="Cancel" name="CmdBackLookAndFeel" form_name="frm_dir"}</td>
                	</tr>
                </table>
            </div>
