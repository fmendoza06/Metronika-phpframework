...
<HEAD>
 ...
 {CopyDataHidden form_name="frm_tablas" hidden_name="selected_tables"}
</HEAD>
         ...
         <td><IMG SRC="web/images/top.gif" WIDTH=5 HEIGHT=6 ALT=""></td>
            ...
            <div style="position:absolute; left:367px; top:211px; width:84px; height:36px; z-index:2">
                <table border="0" align="center">
                	<tr>
                	    <td>{btn_command type="button" value="Generate" name="CmdGenerarAplicacion" form_name="frm_tablas"}</td>
                		<td>{btn_command type="button" value="Cancel" name="CmdBackComponentes" form_name="frm_tablas"}</td>
                	</tr>
                </table>
            </div>

            {hidden name="selected_tables"}
...
{LoadIframe type=$type host=$host db_name=$db_name user=$user pass=$pass cmd="CmdTablasBbIframe"}
</div>  
</body>
