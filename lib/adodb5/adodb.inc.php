...
*/
	...
	*/
	...
	global $ADODB_COUNTRECS;
		...
		$arr = $rs->GetArray();
		$rs->Close();
		//JFMI Se cambiam las claves del arrglo por mayusculas 09-Feb-2013 And New Modification of JFMI for ADODB5 26-Oct-2014
		$arr=$this->change_case_recursive($arr);		
		return $arr;
	}
	//To addition this function to change array key to upper case 
	//JFMI Se cambiam las claves del arrglo por mayusculas 09-Feb-2013 And New Modification of JFMI for ADODB5 26-Oct-2014
    function change_case_recursive($arr){
     foreach ($arr as $key=>$val){
        if (!is_array($arr[$key])){
		    ...
		    $arr[$key]=array_change_key_case($arr[$key],CASE_UPPER);
