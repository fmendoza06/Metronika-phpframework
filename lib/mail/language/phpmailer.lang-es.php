...
$PHPMAILER_LANG['authenticate']         = ''; //'Error SMTP: No se pudo autentificar. Correo no Enviado.';
...
$PHPMAILER_LANG['from_failed']          = 'La(s) siguiente(s) direccion(es) de remitente fallaron: ';
